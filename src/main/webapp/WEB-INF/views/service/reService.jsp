...
<body>
	...
	<div class="backPage" style="width:90vw;">
		<a style="color: gray" href="/potal/serviceList"> <i class="fab fa-hire-a-helper"></i></a> > 복학 신청<br>
	</div>
	
	<div class="report">
	<small style="margin-right: 15px">첨부파일</small>
	<a  class="normalA" href="<c:url value="/resources/file/복학 신청서 양식.docx"/>">복학 신청서 양식.docx</a>
	</div>
...
<br><br><br>
	...
	1. 우측 상단의 <span style="font-weight: bold; margin-left: 3px; margin-right: 3px;"> '복학 신청서 양식' </span> 출력<br>
	2. 화면 하단의 <span style="font-weight: bold; margin-left: 3px; margin-right: 3px;"> '신청하기' </span> 버튼 클릭<br>
 	3. 출력한 신청서를 양식에 맞게 작성한 후 본교 <span style="font-weight: bold; margin-left: 3px; margin-right: 3px;"> '교무처' </span> 방문 후 복학신청 진행<br>
	</div>
...
<script>
	...
	function pageMove(){
		...
		var check = confirm("\n※복학 신청 방법을 잘 확인하시고, 절차에 따라 진행하시기 바랍니다.\n"
				+"\n복학 신청을 접수하시겠습니까?");
		
		
		if(check == false){
			alert("복학 신청 접수를 취소합니다.");
			return;
		}
