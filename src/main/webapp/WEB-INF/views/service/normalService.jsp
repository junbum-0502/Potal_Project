...
<body>
	...
	<a  class="normalA" href="<c:url value="/resources/file/일반휴학 신청서 양식.docx"/>">일반휴학 신청서 양식.docx</a>
	</div>
...
<br><br><br>
	...
	1. 우측 상단의 <span style="font-weight: bold; margin-left: 3px; margin-right: 3px;">'일반휴학 신청서 양식'</span> 출력<br>
...
<script>
	...
	function pageMove(){
		...
		if(check == false){
			alert("일반휴학 신청 접수를 취소합니다.");
			return;
		}
		
		alert("일반휴학 신청이 접수되었습니다. \n신청 내역 페이지로 이동합니다.")
